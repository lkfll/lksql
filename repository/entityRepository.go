...
func (Repository *EntityRepository) Insert(DB exec.SQLCommon, params ...interface{}) (sql.Result, error) {
	...
	return exec.NewInsert(tempsql, ParamList...).Go(DB)
}
...
func (Repository *EntityRepository) Update(param interface{}) func(string) *exec.Update {
